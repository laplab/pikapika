...
$(EXE): bin/main.o bin/hal_core.o bin/hal_fs.o bin/hal_palette.o bin/pico_core.o bin/pico_gfx.o bin/pico_memory.o bin/pico_data.o bin/pico_script.o bin/pico_cart.o bin/utf8-util.o bin/utils.o bin/log.o bin/crypt.o
	$(CXX) $^ $(LDFLAGS) -o $@
...
bin/pico_script.o: src/pico_script.cpp src/pico_script.h src/pico_core.h src/pico_cart.h src/hal_core.h src/hal_fs.h src/log.h src/firmware.lua
	$(CXX) $(CXXFLAGS) $< -o $@
