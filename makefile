...
$(EXE): bin/main.o bin/hal_core.o bin/hal_palette.o bin/pico_core.o bin/pico_gfx.o bin/pico_memory.o bin/pico_data.o bin/pico_script.o bin/pico_cart.o bin/utf8-util.o bin/utils.o bin/log.o
	$(CXX) $^ $(LDFLAGS) -o $@
...
bin/hal_core.o: src/hal_core.cpp src/hal_core.h src/hal_palette.h src/config.h src/log.h
	$(CXX) $(CXXFLAGS) $< -o $@

bin/hal_palette.o: src/hal_palette.cpp src/hal_palette.h
	$(CXX) $(CXXFLAGS) $< -o $@

bin/pico_core.o: src/pico_core.cpp src/pico_core.h src/pico_memory.h src/pico_script.h src/pico_cart.h src/config.h src/utils.h src/log.h
	$(CXX) $(CXXFLAGS) $< -o $@
...
bin/pico_cart.o: src/pico_cart.cpp src/pico_cart.h src/pico_core.h src/pico_script.h src/utils.h src/log.h
	$(CXX) $(CXXFLAGS) $< -o $@

bin/pico_script.o: src/pico_script.cpp src/pico_script.h src/pico_core.h src/pico_cart.h src/hal_core.h src/log.h src/firmware.lua
	$(CXX) $(CXXFLAGS) $< -o $@
